<?php
    ...
    $query = "SELECT cc.*, u.nombre_usuario FROM corte_caja cc INNER JOIN usuarios u ON cc.usuarios_id = u.usuarios_id WHERE cc.tiendas_id = ? AND cc.fecha_fin IS NULL ORDER BY cc.fecha_inicio DESC";
